                ...
                <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="flex gap-2">
                        <button
                            ...
                            onClick={`window.open('https://www.linkedin.com/sharing/share-offsite/?url=https://cohorts-africa.vercel.app&summary=I am mentoring the next generation of African talent on Cohorts.Africa! 🌍 join me as a mentor or mentee.', '_blank')` as any}
                        >
                        ...
                        <button
                            ...
                            onClick={`window.open('https://twitter.com/intent/tweet?text=I am mentoring the next generation of African talent on Cohorts.Africa! 🌍 join me at https://cohorts-africa.vercel.app', '_blank')` as any}
                        >
